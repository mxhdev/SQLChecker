...
INSERT INTO `airport`.`address` 
	VALUES 
		(1,'13405','Berlin','Flughafen Tegel','DE'),
...
INSERT INTO `airport`.`airport` 
	VALUES 
		('CYYZ','Toronto Pearson International Airport',10),
...
DROP TABLE IF EXISTS `airport`.`customer`;
...
INSERT INTO `airport`.`customer` VALUES (15943155,'Müller','Elias',13),(15946782,'Richter','Thomas',20),(16579435,'Schmidt','Alexander',11),(28943155,'Weber','Sabrina',16),(31764155,'Koch','Nicole',17),(35941358,'Weber','Sabine',18),(35943143,'Schneider','Daniel',14),(35943147,'Schmidt','Stefanie',12),(73941738,'Fischer','David',15),(99188655,'Neumann','Emil',19);

/*static*/

DROP TABLE IF EXISTS `airport`.`flightexecution`;
...
INSERT INTO `airport`.`flightexecution` 
	VALUES 
		('IBE1684','2014-12-31 10:30:45','LIRA','ENGM',2,200),
		('IBE1764','2014-12-31 10:30:45','EGLC','EDDT',1,180),
		('IBE1846','2014-12-31 10:30:45','EDDF','EDDL',3,160),
		('IBE3843','2014-12-31 10:30:45','ENGM','EDDM',2,120),
		('IBE4681','2014-12-31 10:30:45','EDDF','LIRA',4,180),
		('LH1167','2014-12-31 10:30:45','LFPG','LGAV',2,180),
		('LH1354','2014-12-31 10:30:45','EDDT','LIRA',1,120),
		('LH1761','2014-12-31 10:30:45','EDDF','EDDT',4,240),
		('LH1769','2014-12-31 10:30:45','LIRA','EDDF',1,180),
		('LH1943','2014-12-31 10:30:45','EDDL','EGLC',2,180),
		('LH1973','2014-12-31 10:30:45','EDDF','LFPG',3,180),
		('LH2301','2014-07-26 10:50:00','EDDF','CYYZ',2,340),
		('LH3333','2014-06-05 09:30:45','EDDF','EDDM',1,155),
		('LH3584','2014-12-31 10:30:45','EDDM','EDDF',1,180),
		('LH3842','2014-12-31 10:30:45','EGLC','EDDL',4,120),
		('LH5301','2014-07-02 16:20:00','EDDF','CYYZ',1,740),
		('LH7660','2014-12-31 10:30:45','LGAV','EDDM',3,240);


/*static*/

DROP TABLE IF EXISTS `airport`.`flights_from_eddf_commingweek`;

/*static*/

DROP TABLE IF EXISTS `airport`.`kunden_details`;

/*static*/


DROP TABLE IF EXISTS `airport`.`kunden_deutschland`;
...
DROP TABLE IF EXISTS `airport`.`reservation`;
...
INSERT INTO `airport`.`reservation` 
	VALUES 
		(1,16579435,1,'','LH1973','2014-12-31 10:30:45'),
		(2,35943147,1,'','LH3584','2014-12-31 10:30:45'),
		(3,15943155,2,'Die Plätze sollten nebeneinander liegen','LH1167','2014-12-31 10:30:45'),
		(4,35943143,1,'','LH7660','2014-12-31 10:30:45'),
		(5,73941738,1,'','LH3842','2014-12-31 10:30:45'),
		(6,28943155,3,'','LH1769','2014-12-31 10:30:45'),
		(7,31764155,1,'','IBE1846','2014-12-31 10:30:45'),
		(8,35941358,1,'Fensterplatz bitte','IBE1764','2014-12-31 10:30:45'),
		(9,99188655,2,'','LH1354','2014-12-31 10:30:45'),
		(10,15946782,1,'','IBE1684','2014-12-31 10:30:45'),
		(11,28943155,1,'','LH1761','2014-12-31 10:30:45'),
		(12,31764155,4,'','IBE4681','2014-12-31 10:30:45'),
		(13,35941358,1,'Platz am Gang bitte','IBE3843','2014-12-31 10:30:45'),
		(14,99188655,2,'','LH1943','2014-12-31 10:30:45'),
		(15,15946782,1,'','IBE3843','2014-12-31 10:30:45'),
		(16,31764155,2,'','LH2301','2014-07-26 10:50:00'),
		(17,15946782,7,'','LH2301','2014-07-26 10:50:00'),
		(18,99188655,1,'','LH5301','2014-07-02 18:20:00');


/*static*/

INSERT INTO `airport`.`country` (`CountryISO3166_2LetterCode`, `CountryName`) 
	VALUES
		('AD', 'Andorra'),
...
INSERT INTO 
		`airport`.`flightexecution` (`FlightNo`, `DepartureDateAndTimeUTC`, `ICAO_Code_Origin`, `ICAO_Code_Destination`, `PlaneID`, `FlightDurationInMinutes`) 
	VALUES
